...
$str="select * from users where username='$id' and password='$pwd'";
...
<style>
body {
  background: url(servback.jpg) no-repeat center center fixed;
...
<div class="form-style-8">
  ...
  <form method="post">
    ...
    <input type="submit" value="Login" name="submit"/></form><span>&nbsp&nbsp&nbsp
<span> 
</div>
